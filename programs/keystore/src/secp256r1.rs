...
impl Secp256r1InstructionData {
    ...
    pub fn try_from_slice(data: &[u8]) -> Result<Self> {
        require!(data.len() >= 13, ProgramError::InvalidInstructionData);
        
        let num_signatures = data[0];
        require!(num_signatures == 1, ProgramError::InvalidInstructionData);
...
pub fn verify_secp256r1_signature(
    ...
    require!(found_valid, ProgramError::InvalidInstructionData);
